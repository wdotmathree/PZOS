...
test: img
	...
	# qemu-system-x86_64 -cpu max -m 4G -drive file=PZOS.bin,format=raw -serial mon:stdio -nographic
...
debug: img
	...
	qemu-system-x86_64 -cpu max -m 4G -drive file=PZOS.bin,format=raw -serial mon:stdio -nographic -s -S
