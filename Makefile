...
debug: img
	...
	qemu-system-x86_64 -nographic -serial file:/dev/stdout -s -S -machine q35 -bios /usr/share/qemu/OVMF.fd $(QEMU_FLAGS)
	# qemu-system-x86_64 -monitor stdio -s -S -machine q35 -bios /usr/share/qemu/OVMF.fd $(QEMU_FLAGS)
